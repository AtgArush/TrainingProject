...
export default function DuelBLock({heading, imageUrl, linker}) {
    return (
                    ...
                    <div className="col-4">
                        <div className="card">
                            ...
                            <div className="card-body">
                                ...
                                <button className = "btn btn-primary btnCard btn-block">    
                                    <Link to={linker} className="cardtext">{heading}</Link>
                                </button>
                                </div>
                            </div>
                        </div>
